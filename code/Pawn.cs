...
partial class Pawn : AnimatedEntity
{
	...
	public override void Simulate( IClient cl )
	{
		...
		if ( Game.IsServer && Input.Pressed( "attack1" ) )
		{
			...
			Transform spawnPoint = new Transform();

			spawnPoint.Rotation = Rotation.LookAt( new Vector3( 0.00448f, -0.00931f, 0.90085f ) );

			

			Log.Info( Position );
			foreach(Sandbox.Entity entity in Sandbox.Entity.All) {


				
				if (entity.Tags.Has("grid-start")) {
					Log.Info( entity );
				}
